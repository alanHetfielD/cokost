...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2019 at 06:20 AM
...
INSERT INTO `kamar` (`kamar_id`, `kamar_type`, `kamar_harga`, `kamar_panjang`, `kamar_lebar`, `kamar_foto`, `kamar_facility`, `kamar_quantity`, `kamar_hit`) VALUES
(15, 'a', 1000000, '1', '1', '2018-12-19-04-13-35a0.jpg;2018-12-19-04-13-35a1.png;2018-12-19-04-13-35a2.jpg;2018-12-19-04-13-35a3.jpg', 'tempat tidur ;kamar mandi dalam', 1, 0),
(16, 'B', 0, '0', '0', 'arduino-electronic-elements-vector-4199760.jpg;naruto_sprite_game_animation_by_backyardcabinxy.png', 'B', 0, 0),
(17, 'B', 0, '0', '0', 'Capture3.JPG;naruto_sprite_game_animation_by_backyardcabinxy.png', 'B', 0, 0);
...
(8, 7, 'alan', 'alan', 'alan', 'alan', '2018-12-19-03-45-25street-lighting-pole-500x500.jpg', 'alana', 0),
(9, 7, 'asdf', 'asdf', 'asdf', 'asdf', '2018-12-19-04-22-10download.png', 'asdffdfd', 0),
(10, 7, 'b', 'b', 'b', 'b', '2018-12-20-07-40-56arduino-fixed.jpg', 'b', 0),
(11, 7, 'A', 'A', '1', '1', 'arduino-electronic-elements-vector-4199760.jpg', 'A', 0),
(12, 7, 'A', 'A', '1', '1', 'arduino-electronic-elements-vector-4199760.jpg', 'A', 0);
...
(941, '2018-11-20 02:35:38', 'access HOMEPAGE without session', 0),
(942, '2018-11-20 02:35:41', 'LOGIN user => root , result => true', 1),
(943, '2018-11-20 02:35:42', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1),
(944, '2018-11-22 14:45:35', 'access HOMEPAGE without session', 0),
(945, '2018-11-29 08:23:52', 'access HOMEPAGE without session', 0),
(946, '2018-11-29 08:23:54', 'access HOMEPAGE without session', 0),
(947, '2018-11-29 08:23:59', 'access HOMEPAGE without session', 0),
(948, '2018-11-29 08:24:54', 'access HOMEPAGE without session', 0),
(949, '2018-11-29 08:26:20', 'access HOMEPAGE without session', 0),
(950, '2018-11-29 08:26:23', 'access HOMEPAGE without session', 0),
(951, '2018-12-01 09:20:27', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1),
(952, '2018-12-01 09:20:48', 'access HOMEPAGE without session', 0),
(953, '2018-12-01 09:20:51', 'LOGIN user => root , result => true', 1),
(954, '2018-12-01 09:20:51', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1),
(955, '2018-12-01 09:21:25', 'ADD DOCUMENT () :  user => root( id = 1) ; result => VIEW; ', 1),
(956, '2018-12-19 12:43:19', 'access HOMEPAGE without session', 0),
(957, '2018-12-19 12:43:23', 'access HOMEPAGE without session', 0),
(958, '2018-12-19 12:43:47', 'access HOMEPAGE without session', 0),
(959, '2018-12-19 12:43:58', 'access HOMEPAGE without session', 0),
(960, '2018-12-19 12:44:11', 'access HOMEPAGE without session', 0),
(961, '2018-12-19 12:44:16', 'LOGIN user => root , result => true', 1),
(962, '2018-12-19 12:44:16', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1),
(963, '2018-12-19 12:44:21', 'LOGOUT  user => root( id = 1) ; result => true', 1),
(964, '2018-12-19 12:44:21', 'access HOMEPAGE without session', 0),
(965, '2018-12-19 12:44:28', 'LOGIN user => root , result => true', 1),
(966, '2018-12-19 12:44:28', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1),
(967, '2018-12-19 12:44:34', 'ADD DOCUMENT () :  user => root( id = 1) ; result => VIEW; ', 1),
(968, '2018-12-19 12:44:36', 'ADD DOCUMENT () :  user => root( id = 1) ; result => VIEW; ', 1),
(969, '2018-12-19 12:47:06', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(970, '2018-12-19 12:47:12', 'DELETE USER (muhalfalah) BY ():  user => root( id = 1) ; result => true', 1),
(971, '2018-12-19 12:47:12', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(972, '2018-12-19 12:47:14', 'ADD DOCUMENT () :  user => root( id = 1) ; result => VIEW; ', 1),
(973, '2018-12-19 12:47:15', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1),
(974, '2018-12-19 12:47:38', 'ADD DOCUMENT () :  user => root( id = 1) ; result => VIEW; ', 1),
(975, '2018-12-19 12:47:40', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1),
(976, '2018-12-19 12:47:43', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1),
(977, '2018-12-19 13:24:59', 'LOGOUT  user => root( id = 1) ; result => true', 1),
(978, '0000-00-00 00:00:00', 'true', 1),
(979, '2018-12-19 13:29:01', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1),
(980, '2018-12-19 13:30:34', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1),
(981, '2018-12-19 13:30:38', 'LOGOUT  user => root( id = 1) ; result => true', 1),
(982, '0000-00-00 00:00:00', 'true', 1),
(983, '2018-12-19 13:30:41', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1),
(984, '2018-12-19 13:30:43', 'LOGOUT  user => root( id = 1) ; result => true', 1),
(985, '2018-12-19 13:32:30', 'a person REGISTER in system ; result =>false', 0),
(986, '2018-12-19 13:33:22', 'a person REGISTER in system ; result =>false', 0),
(987, '2018-12-19 13:34:45', 'a person REGISTER in system ; result =>false', 0),
(988, '0000-00-00 00:00:00', 'true', 1),
(989, '2018-12-19 13:36:41', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1),
(990, '2018-12-19 13:36:44', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(991, '2018-12-19 13:37:06', 'a person REGISTER in system ; result =>true', 0),
(992, '0000-00-00 00:00:00', 'false =>Username atau password salah!', 0),
(993, '0000-00-00 00:00:00', 'false =>Username atau password salah!', 0),
(994, '2018-12-19 13:37:56', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(995, '2018-12-19 13:37:59', 'DELETE USER (asdf) BY ():  user => root( id = 1) ; result => true', 1),
(996, '2018-12-19 13:37:59', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(997, '2018-12-19 13:38:01', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(998, '2018-12-19 13:38:07', 'a person REGISTER in system ; result =>false', 0),
(999, '2018-12-19 13:38:23', 'a person REGISTER in system ; result =>true', 0),
(1000, '0000-00-00 00:00:00', 'false =>Username atau password salah!', 0),
(1001, '2018-12-19 13:38:35', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(1002, '2018-12-19 13:38:41', 'EDIT USER (asdfasdf) BY ():  user => root( id = 1) ; result => true', 1),
(1003, '2018-12-19 13:38:41', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(1004, '0000-00-00 00:00:00', 'true', 7),
(1005, '2018-12-19 13:38:50', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1006, '2018-12-19 13:38:52', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1007, '2018-12-19 13:38:53', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1008, '2018-12-19 15:21:02', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1009, '2018-12-19 15:21:05', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1010, '2018-12-19 15:21:07', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1011, '2018-12-19 15:21:08', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1012, '2018-12-19 15:21:10', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1013, '2018-12-19 15:22:00', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1014, '2018-12-19 15:22:05', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1015, '2018-12-19 15:22:34', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1016, '2018-12-19 15:24:50', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1017, '2018-12-19 15:24:55', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1018, '2018-12-19 15:33:03', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1019, '2018-12-19 15:34:13', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1020, '2018-12-19 15:35:24', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1021, '2018-12-19 15:36:56', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1022, '2018-12-19 15:45:04', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1023, '2018-12-19 15:45:25', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => true', 7),
(1024, '2018-12-19 15:45:25', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1025, '2018-12-19 15:46:51', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1026, '2018-12-19 15:56:44', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1027, '2018-12-19 16:14:09', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1028, '2018-12-19 16:21:53', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1029, '2018-12-19 16:22:10', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => true', 7),
(1030, '2018-12-19 16:22:10', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1031, '2018-12-19 16:22:12', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1032, '2018-12-19 16:22:17', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1033, '0000-00-00 00:00:00', 'true', 1),
(1034, '2018-12-20 06:50:36', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1),
(1035, '2018-12-20 06:50:38', 'ADD DOCUMENT () :  user => root( id = 1) ; result => VIEW; ', 1),
(1036, '2018-12-20 06:50:48', 'ADD DOCUMENT () :  user => root( id = 1) ; result => VIEW; ', 1),
(1037, '2018-12-20 06:50:49', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1),
(1038, '2018-12-20 06:50:51', 'ADD DOCUMENT () :  user => root( id = 1) ; result => VIEW; ', 1),
(1039, '2018-12-20 06:50:53', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(1040, '2018-12-20 06:51:03', 'access ADMIN : NOT ADMIN BYuser => ( id = -1) ', -1),
(1041, '0000-00-00 00:00:00', 'true', 7),
(1042, '2018-12-20 06:51:10', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1043, '2018-12-20 06:51:36', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1044, '2018-12-20 06:51:37', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1045, '2018-12-20 07:34:50', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1),
(1046, '2018-12-20 07:35:25', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(1047, '0000-00-00 00:00:00', 'true', 7),
(1048, '2018-12-20 07:38:48', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1049, '2018-12-20 07:39:58', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1050, '2018-12-20 07:40:32', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1051, '2018-12-20 07:40:35', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1052, '2018-12-20 07:40:36', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1053, '2018-12-20 07:40:37', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1054, '2018-12-20 07:40:56', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => true', 7),
(1055, '2018-12-20 07:40:56', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1056, '2018-12-20 07:44:40', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1057, '2018-12-20 07:47:07', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1058, '2018-12-20 07:54:07', 'ADD DOCUMENT () :  user => root( id = 1) ; result => VIEW; ', 1),
(1059, '2018-12-20 07:54:41', 'ADD DOCUMENT () :  user => asdfasdf( id = 7) ; result => VIEW; ', 7),
(1060, '2018-12-20 07:54:54', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1061, '2018-12-20 07:54:58', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1062, '2018-12-20 07:55:50', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1063, '2018-12-20 07:56:38', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1064, '2018-12-20 07:56:41', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1065, '2018-12-20 07:56:58', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1066, '2018-12-20 09:49:00', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1067, '0000-00-00 00:00:00', 'true', 1),
(1068, '2018-12-23 02:28:03', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1),
(1069, '2018-12-23 02:28:05', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(1070, '2018-12-23 02:29:07', 'EDIT USER (a) BY ():  user => root( id = 1) ; result => true', 1),
(1071, '2018-12-23 02:29:07', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(1072, '2018-12-23 02:29:19', 'DELETE USER (a) BY ():  user => root( id = 1) ; result => true', 1),
(1073, '2018-12-23 02:29:19', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(1074, '2018-12-23 02:29:21', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(1075, '0000-00-00 00:00:00', 'true', 1),
(1076, '2018-12-24 14:05:39', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1),
(1077, '0000-00-00 00:00:00', 'true', 1),
(1078, '2018-12-25 03:39:09', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1),
(1079, '2018-12-25 03:39:10', 'ADD DOCUMENT () :  user => root( id = 1) ; result => VIEW; ', 1),
(1080, '0000-00-00 00:00:00', 'true', 1),
(1081, '2019-01-01 06:41:56', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1),
(1082, '2019-01-01 06:41:59', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(1083, '2019-01-01 06:45:37', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(1084, '2019-01-01 06:46:17', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(1085, '2019-01-01 06:48:13', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(1086, '2019-01-01 06:49:11', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(1087, '2019-01-01 06:49:21', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(1088, '2019-01-01 06:50:02', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(1089, '2019-01-01 06:52:19', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(1090, '2019-01-01 06:52:25', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(1091, '2019-01-01 06:52:33', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(1092, '0000-00-00 00:00:00', 'true', 1),
(1093, '2019-01-27 10:31:19', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1),
(1094, '2019-01-27 10:31:23', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(1095, '2019-01-27 10:31:27', 'LOGOUT  user => root( id = 1) ; result => true', 1),
(1096, '0000-00-00 00:00:00', 'false =>Username atau password salah!', 0),
(1097, '0000-00-00 00:00:00', 'true', 1),
(1098, '2019-01-27 10:31:43', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1),
(1099, '2019-01-27 10:31:44', 'access ADMIN : VIEW user => root( id = 1) ', 1),
(1100, '2019-01-27 10:31:48', 'LOGOUT  user => root( id = 1) ; result => true', 1),
(1101, '0000-00-00 00:00:00', 'true', 7),
(1102, '2019-01-27 10:31:52', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1103, '2019-01-27 10:32:58', 'HOMEPAGE :  user => asdfasdf( id = 7) ; result => true', 7),
(1104, '2019-02-13 16:37:07', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1),
(1105, '2019-02-13 16:37:16', 'HOMEPAGE :  user => root( id = 1) ; result => true', 1);
...
--
-- Table structure for table `mobile_pemilik`
--

CREATE TABLE `mobile_pemilik` (
  `mobile_pemilik_id` int(11) NOT NULL,
  `mobile_pemilik_version` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `mobile_pemilik`
--

INSERT INTO `mobile_pemilik` (`mobile_pemilik_id`, `mobile_pemilik_version`) VALUES
(1, 0);
...
(7, 'asdfasdf', '6a204bd89f3c8348afd5c77c717a097a', 1, 2);
...
(7, 'aadf', 'asdf', '', 'alan@gmail.com', '123412341234');
...
--
-- Indexes for table `mobile_pemilik`
--
ALTER TABLE `mobile_pemilik`
  ADD PRIMARY KEY (`mobile_pemilik_id`);
...
--
ALTER TABLE `kamar`
  MODIFY `kamar_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `kepemilikan`
--
ALTER TABLE `kepemilikan`
  MODIFY `kepemilikan_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `kost`
--
ALTER TABLE `kost`
  MODIFY `kost_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `log`
--
ALTER TABLE `log`
  MODIFY `log_id` mediumint(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1106;
...
--
-- AUTO_INCREMENT for table `mobile_pemilik`
--
ALTER TABLE `mobile_pemilik`
  MODIFY `mobile_pemilik_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
