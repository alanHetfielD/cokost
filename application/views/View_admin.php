                    ...
                    <div class="widget-box widget-color-orange" id="widget-box-3">
                        ...
                        <div class="row">
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                foreach( $mobiles_pemilik as $mobile ):
                                ?>
                                <tr>
                                    <td>
                                        <?php echo $no?>
                                    ...
                                    <td>
                                        <?php echo $mobile->mobile_pemilik_version?>
                                    </td>
                                    <td>
                                        <button class="btn btn-white btn-info btn-bold btn-xs" data-toggle="modal" data-target="#editModalMobilePemilik<?php echo $mobile->mobile_pemilik_id;?>">
                                            <i class="ace-icon fa fa-edit bigger-120 blue"></i>
                                        </button>
                                    </td>
                                </tr>
                                    <!-- mdals -->
                                    <!-- Modal Edit-->
                                    <div class="modal fade" id="editModalMobilePemilik<?php echo $mobile->mobile_pemilik_id;?>" role="dialog">
                                        <div class="modal-dialog">
                                        <!-- Modal content-->
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                            <?php echo form_open('admin/edit_mobile_version_pemilik');?>
                                            <div class="box-body">
                                                <div class="form-group">
                                                    <label>Mobile Version</label>
                                                    <color class="text-red"> *</color>
                                                    <input type="hidden" class="form-control" value='<?php echo $mobile->mobile_pemilik_id; ?>' name="mobile_pemilik_id" required="required" readonly>
                                                    <input type="text" class="form-control" value='<?php echo $mobile->mobile_pemilik_version; ?>' name="mobile_pemilik_version" required="required" >
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-primary">Edit</button>
